...
export default function Homepage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-indigo-950 text-white overflow-hidden relative">
      ...
      {/* Navbar with glass morphism - improved spacing */}
      <nav className="relative z-50 flex justify-between items-center px-6 sm:px-8 lg:px-12 py-4 sm:py-5 backdrop-blur-md bg-gray-950/30 border-b border-gray-800/50 sticky top-0">
        <div className="flex items-center space-x-3">
          ...
          <h1 className={`text-xl sm:text-2xl font-bold bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent transition-all duration-300 ${glowingText ? 'drop-shadow-[0_0_15px_rgba(99,102,241,0.7)]' : ''}`}>
            ForgeUI
          </h1>
        </div>
        
        <div className="flex items-center space-x-4 sm:space-x-8">
          <a href="#features" className="text-sm sm:text-base text-gray-300 hover:text-white transition-colors relative group">
            Features
          ...
          <div className="flex space-x-2 sm:space-x-3">
            <Link
              to="/workspace"
              className="relative group px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg font-medium overflow-hidden border border-indigo-500/50 text-sm sm:text-base"
            ...
            <Link
              ...
              className="relative group px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg font-medium overflow-hidden bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 shadow-lg shadow-indigo-500/25 text-sm sm:text-base"
            >
      ...
      <section className="relative text-center pt-20 sm:pt-24 md:pt-28 pb-16 sm:pb-20 md:pb-24 px-4 sm:px-6">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="inline-block px-4 sm:px-6 py-2 sm:py-3 bg-indigo-500/10 backdrop-blur-sm rounded-full border border-indigo-500/20 text-indigo-400 text-xs sm:text-sm font-medium mb-8 sm:mb-10 animate-fade-in-down">
            🚀 Deterministic & Dynamic AI UI Generation
          </div>
          
          <h2 className={`text-4xl sm:text-5xl md:text-7xl font-bold mb-6 sm:mb-8 leading-tight transition-all duration-700 ${glowingText ? 'scale-105' : ''}`}>
          ...
          <p className="text-gray-400 max-w-3xl mx-auto text-base sm:text-lg md:text-xl leading-relaxed mb-10 sm:mb-12 px-4 animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mb-8 sm:mb-10">
            <Link
              to="/workspace"
              className="group relative inline-flex items-center space-x-3 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-700 hover:to-indigo-600 rounded-xl text-base sm:text-lg font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-[0_0_30px_rgba(99,102,241,0.5)] min-w-[200px] sm:min-w-[220px] justify-center"
            >
            ...
            <Link
              to="/workspace-dynamic"
              className="group relative inline-flex items-center space-x-3 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 rounded-xl text-base sm:text-lg font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-[0_0_30px_rgba(168,85,247,0.5)] min-w-[200px] sm:min-w-[220px] justify-center"
            >
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-8 text-xs sm:text-sm text-gray-500 animate-fade-in px-4">
      ...
      <section id="features" className="relative px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-24 bg-gradient-to-b from-gray-900/50 via-gray-900 to-gray-950">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            <span className="text-indigo-400 font-semibold text-xs sm:text-sm uppercase tracking-wider">
              Two Powerful Modes
            </span>
            <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold mt-4 mb-4 sm:mb-6 bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent px-4">
          ...
          {/* Mode Cards - improved spacing */}
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 mb-16 sm:mb-20 lg:mb-24">
            ...
            <div className="group relative animate-fade-in-up">
              ...
              <div className="relative bg-gray-800/90 backdrop-blur-sm p-6 sm:p-8 lg:p-10 rounded-2xl border border-indigo-500/30 hover:border-transparent transition-all duration-500 transform group-hover:-translate-y-2">
                <div className="flex items-center justify-between mb-6 sm:mb-8">
                  <div className="text-4xl sm:text-5xl transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-300">
                    🎯
                  </div>
                  <span className="px-3 py-1 bg-indigo-500/20 text-indigo-400 rounded-full text-xs sm:text-sm font-medium">Deterministic</span>
                </div>
                <h4 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-indigo-400 to-blue-400 bg-clip-text text-transparent">
                ...
                <Link
                  to="/workspace"
                  className="mt-6 sm:mt-8 inline-flex items-center space-x-2 text-indigo-400 hover:text-indigo-300 transition-colors group/link text-sm sm:text-base"
                >
            ...
            <div className="group relative animate-fade-in-up">
              ...
              <div className="relative bg-gray-800/90 backdrop-blur-sm p-6 sm:p-8 lg:p-10 rounded-2xl border border-purple-500/30 hover:border-transparent transition-all duration-500 transform group-hover:-translate-y-2">
                <div className="flex items-center justify-between mb-6 sm:mb-8">
                  <div className="text-4xl sm:text-5xl transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-300">
                    ✨
                  </div>
                  <span className="px-3 py-1 bg-purple-500/20 text-purple-400 rounded-full text-xs sm:text-sm font-medium">Dynamic</span>
                </div>
                <h4 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                ...
                <Link
                  to="/workspace-dynamic"
                  className="mt-6 sm:mt-8 inline-flex items-center space-x-2 text-purple-400 hover:text-purple-300 transition-colors group/link text-sm sm:text-base"
                >
          ...
          {/* Features Heading - improved spacing */}
          <div className="text-center mb-10 sm:mb-12 lg:mb-16">
            <span className="text-indigo-400 font-semibold text-xs sm:text-sm uppercase tracking-wider">
              Core Features
            </span>
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mt-3 sm:mt-4 mb-4 sm:mb-6 bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent px-4">
              Everything You Need to Build Better UIs
            </h3>
            <div className="w-20 sm:w-24 h-1 bg-gradient-to-r from-indigo-500 to-purple-500 mx-auto mt-3 sm:mt-4 rounded-full" />
          </div>
      ...
      <section className="relative py-20 sm:py-24 md:py-28 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 sm:mb-8 px-4">
            Ready to Transform Your
            <span className="bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent block mt-3 sm:mt-4">
              UI Development Workflow?
            </span>
          </h3>
          
          <p className="text-gray-400 text-base sm:text-lg md:text-xl mb-10 sm:mb-12 px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 px-4">
            <Link
              to="/workspace"
              className="group relative inline-flex items-center space-x-3 px-8 sm:px-10 py-4 sm:py-5 bg-gradient-to-r from-indigo-600 to-indigo-500 rounded-xl sm:rounded-2xl text-lg sm:text-xl font-bold transform hover:scale-105 sm:hover:scale-110 transition-all duration-500 hover:shadow-[0_0_30px_sm:0_0_40px_rgba(99,102,241,0.6)] w-full sm:w-auto justify-center"
            >
              <span>Deterministic Mode</span>
            ...
            <Link
              to="/workspace-dynamic"
              className="group relative inline-flex items-center space-x-3 px-8 sm:px-10 py-4 sm:py-5 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl sm:rounded-2xl text-lg sm:text-xl font-bold transform hover:scale-105 sm:hover:scale-110 transition-all duration-500 hover:shadow-[0_0_30px_sm:0_0_40px_rgba(168,85,247,0.6)] w-full sm:w-auto justify-center"
            >
              <span>Dynamic Mode</span>
              <span className="group-hover:translate-x-2 transition-transform">✨</span>
            </Link>
      ...
      <footer className="relative border-t border-gray-800/50 backdrop-blur-sm bg-gray-950/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-6">
            <div className="flex items-center space-x-3">
              <div className="w-8 sm:w-10 h-8 sm:h-10 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center">
                <span className="text-xl sm:text-2xl">⚡</span>
              </div>
              <span className="text-lg sm:text-xl font-semibold bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
                ForgeUI
              </span>
            </div>
...
function FeatureCard({ icon, title, description, gradient, delay = 0 }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-gray-800/90 backdrop-blur-sm p-6 sm:p-7 lg:p-8 rounded-2xl border border-gray-700/50 hover:border-transparent transition-all duration-500 transform group-hover:-translate-y-2 h-full flex flex-col">
        {/* Icon with animation */}
        <div className="text-3xl sm:text-4xl mb-3 sm:mb-4 transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-300">
          {icon}
        </div>
        
        <h4 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent group-hover:from-indigo-300 group-hover:to-purple-300 transition-all duration-300">
          {title}
        </h4>
        ...
        <div className="absolute bottom-4 sm:bottom-6 right-4 sm:right-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <svg className="w-4 h-4 sm:w-5 sm:h-5 text-indigo-400 transform group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// Inject styles (make sure this only runs on the client)
